...
namespace DFC.App.DiscoverSkillsCareers.Services.UnitTests.ContentProcessorTests
{
    ...
    public class DysacTraitProcessorTests : BaseContentProcessorTests
    {
        ...
        public async Task DysacTraitProcessorProcessContentItemAsyncCreateReturnsOk()
        {
            ...
            A.CallTo(() => FakeDocumentStore.GetContentByIdAsync<DysacTraitContentModel>(A<Guid>.Ignored, A<string>.Ignored, "Test"))
            ...
            A.CallTo(() => FakeDocumentStore.GetContentByIdAsync<DysacTraitContentModel>(A<Guid>.Ignored, A<string>.Ignored, "Test")).MustHaveHappened();
