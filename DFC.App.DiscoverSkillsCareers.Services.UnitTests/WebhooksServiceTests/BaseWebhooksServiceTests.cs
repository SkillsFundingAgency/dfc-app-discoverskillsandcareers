...
namespace DFC.App.DiscoverSkillsCareers.Services.UnitTests.WebhooksServiceTests
{
    public abstract class BaseWebhooksServiceTests
    {
        ...
        protected void SetupContentProcessors()
        {
            ...
            A.CallTo(() => FakeContentProcessors[0].DeleteContentAsync(A<Guid>.Ignored, string.Empty)).Returns(System.Net.HttpStatusCode.OK);
            A.CallTo(() => FakeContentProcessors[0].DeleteContentItemAsync(A<Guid>.Ignored, A<Guid>.Ignored, A<string>.Ignored)).Returns(System.Net.HttpStatusCode.OK);
            ...
            A.CallTo(() => FakeContentProcessors[1].DeleteContentAsync(A<Guid>.Ignored, string.Empty)).Returns(System.Net.HttpStatusCode.OK);
            A.CallTo(() => FakeContentProcessors[1].DeleteContentItemAsync(A<Guid>.Ignored, A<Guid>.Ignored, A<string>.Ignored)).Returns(System.Net.HttpStatusCode.OK);
            ...
            A.CallTo(() => FakeContentProcessors[2].DeleteContentAsync(A<Guid>.Ignored, string.Empty)).Returns(System.Net.HttpStatusCode.OK);
            A.CallTo(() => FakeContentProcessors[2].DeleteContentItemAsync(A<Guid>.Ignored, A<Guid>.Ignored, A<string>.Ignored)).Returns(System.Net.HttpStatusCode.OK);
