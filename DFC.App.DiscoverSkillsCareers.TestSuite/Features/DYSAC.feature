...
Scenario: Starting Assessment loads the first questions
	...
	Then The first question is displayed; I like to get involved in making things
...
Scenario: Starting Assessment loads the questions and show the percentage completion 
	...
	When I select Strongly agree option
	And I click Next
	Then The next question is displayed; I am comfortable telling people what they need to do.	
